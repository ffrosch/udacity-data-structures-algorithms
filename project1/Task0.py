...
def test():
    ...
    assert(last_call == ['98447 62998', '(080)46304537',
...
print(
    f'First record of texts, {first_sms[0]} texts {first_sms[1]} at time {first_sms[2]}') # noqa
print(
    f'Last record of calls, {last_call[0]} calls {last_call[1]} at time {last_call[2]}, lasting {last_call[3]} seconds') # noqa
