...
class HashMap:
    ...
    def get_hash(self, key):
        ...
        hash_value = 0
        for char in str(key):
            # result of the compression will always be a number in range(self.bucket_size)
            #   this number can thus safely be used as an index to where in self.bucket_arr
